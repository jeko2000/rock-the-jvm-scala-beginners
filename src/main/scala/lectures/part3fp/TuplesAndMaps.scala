...
object TuplesAndMaps {
  ...
  /*
   ...
   and we ran the mapping function above to get lower cased keys?
   ...
   - how many people havbe no friends
   - if there are social connection between two people (direct or not)
   */

  // 1
  // I think only of them would be kept and the other one would be shadowed.

  val newMap = Map[String, Int]("JIM" -> 545, "Jim" -> 900)
  println(newMap)
